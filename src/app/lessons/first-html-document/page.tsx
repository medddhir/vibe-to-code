...
const lessonSlug = "first-html-document";
const route = "/lessons/first-html-document";
...
const courseLessonNumber = getFoundationsCourseLessonNumber(lessonSlug) ?? 19;
const guidedSteps = getGuidedStepsForLessonDefinition(definition);
export const metadata: Metadata = { title: "Level 2 · Lesson 5: Build your first HTML document", description: definition.objective };

export default async function FirstHtmlDocumentLesson() {
