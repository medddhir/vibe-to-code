...
const sortChoices: ChoiceCheckpointOption[] = [
  {
    id: "html",
    label: "HTML file for visible page structure.",
    feedback: "Correct. Use this language for markup and layout containers.",
  },
  {
    id: "js",
    label: "HTML file for arithmetic and button listeners.",
    feedback: "Those behaviors belong in JavaScript.",
  },
  {
    id: "css",
    label: "CSS file to handle syntax parsing and loops.",
    feedback: "CSS is for style rules, not language parsing across loops.",
  },
];
    ...
    >
      ...
      <section id="language-sorting" className="lesson-section guided-topic mission-topic">
        ...
        <ChoiceCheckpoint
          ...
          question="Where should this line most likely live? <code>body { margin: 0; }</code>"
          options={sortChoices}
          correctId="html"
