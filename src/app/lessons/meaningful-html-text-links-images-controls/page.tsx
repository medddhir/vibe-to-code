...
const lessonSlug = "meaningful-html-text-links-images-controls";
const route = "/lessons/meaningful-html-text-links-images-controls";
...
const courseLessonNumber = getFoundationsCourseLessonNumber(lessonSlug) ?? 20;
const guidedSteps = getGuidedStepsForLessonDefinition(definition);
export const metadata: Metadata = { title: "Level 2 · Lesson 6: Meaningful HTML", description: definition.objective };

export default async function MeaningfulHtmlLesson() {
