...
const lessonSlug = "urls-domains-dns-paths-queries";
const route = "/lessons/urls-domains-dns-paths-queries";
...
const courseLessonNumber = getFoundationsCourseLessonNumber(lessonSlug) ?? 16;
const guidedSteps = getGuidedStepsForLessonDefinition(definition);

export const metadata: Metadata = { title: "Level 2 · Lesson 2: URLs, domains, DNS, paths, and queries", description: definition.objective };

export default async function UrlsDomainsDnsPathsQueriesLesson() {
