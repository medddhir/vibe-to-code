...
const lessonSlug = "browser-developer-tools";
const route = "/lessons/browser-developer-tools";
...
const courseLessonNumber = getFoundationsCourseLessonNumber(lessonSlug) ?? 18;
const guidedSteps = getGuidedStepsForLessonDefinition(definition);
export const metadata: Metadata = { title: "Level 2 · Lesson 4: Your browser's developer tools", description: definition.objective };

export default async function BrowserDeveloperToolsLesson() {
