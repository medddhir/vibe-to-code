...
const lessonSlug = "box-model-layout-responsive-design";
const route = "/lessons/box-model-layout-responsive-design";
...
const lessonNumber = getFoundationsLessonNumber(lessonSlug) ?? 8;
const courseLessonNumber = getFoundationsCourseLessonNumber(lessonSlug) ?? 22;
const guidedSteps = getGuidedStepsForLessonDefinition(definition);
export const metadata: Metadata = { title: "Level 2 · Lesson 8: Box model, layout, and responsive design", description: definition.objective };

export default async function BoxModelLayoutLesson() {
