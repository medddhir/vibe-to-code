...
const lessonSlug = "javascript-dom-events";
const route = "/lessons/javascript-dom-events";
...
const lessonNumber = getFoundationsLessonNumber(lessonSlug) ?? 9;
const courseLessonNumber = getFoundationsCourseLessonNumber(lessonSlug) ?? 23;
const guidedSteps = getGuidedStepsForLessonDefinition(definition);
export const metadata: Metadata = { title: "Level 2 · Lesson 9: JavaScript, the DOM, and events", description: definition.objective };

export default async function JavaScriptDomEventsLesson() {
